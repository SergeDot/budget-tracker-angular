...
let TransactionController = class TransactionController {
    ...
    findAllWithPagination(req, page, limit) {
        const pageNumber = Number(page) || 1;
        const limitNumber = Number(limit) || 3;
        return this.transactionService.findAllWithPagination(+req.user.id, pageNumber, limitNumber);
    }
    findAll(req) {
    ...
    update(transactionId, updateTransactionDto) {
