...
const TransactionTable: FC<ITransactionTable> = ({ limit = 3 }) => {
	...
	const handlePageChange = (selectedItem: { selected: number }) => { // ReactPagination's method. The method to call when a page is clicked. Exposes the current page object as an argument.
	...
	return (
		<>
    {/* TODO: hide pagination when no data */}
    {/* TODO: add user defined number of items on the page */}
			<ReactPaginate
        ...
        renderOnZeroPageCount={null} // OWNFIX: not present in prod
			/>
					...
					<tbody>
						{data?.map((transaction, idx) => (
							<tr key={idx}>
								...
								{/* TODO: add default undeletable category 'Other' */}
								{/* TODO: check fast double click - returns 404  */}
